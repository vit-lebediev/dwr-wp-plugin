...
Робокассы - это платежный агрегатор, позволяющий принимать платежи с помощью огромного набора способов, включая QIWI, Вебмани, Яндекс.Деньги, Деньги@Mail.ru,
...
Или же компактную кнопку для сайдбара, где не так много места. Нажав на неё, пользователь будет перенаправлен на страницу приема платежа,
...
3. Откройте меню "Параметры -> Donate With Robokassa (DWR)" и заполните все необходимые поля (более детально о них можно почитать [тут](https://github.com/Malgin/dwr-wp-plugin#donate-with-robokassa-dwr-settings-page)).
4. Добавьте **[dwr_payment_widget]** шорткод в любую запись или на любую страницу, туда, где бы вы хотели видеть виджет приема платежей.
